...
const DataStore = {
    ...
    createExampleProject() {
        const exampleProject = {
            ...
            nodes: [
                // 系统节点 — 根级父节点（无parentId）带 parentColor 颜色标识
                // 主线地图系（蓝色）
                { id: 'n1', name: '主线地图', type: 'system', subType: null, level: 1, parentId: null, parentColor: '#3b82f6', x: 400, y: 80, tags: ['PVE'], description: '主要推图系统', inputPorts: [{id:'in0',name:'输入'}], outputPorts: [{id:'out0',name:'产出'}] },
                ...
                // 人物养成系（紫色）
                { id: 'n4', name: '人物养成', type: 'system', subType: null, level: 1, parentId: null, parentColor: '#8b5cf6', x: 400, y: 380, tags: ['核心'], description: '角色成长系统', inputPorts: [{id:'in0',name:'经验输入'},{id:'in1',name:'材料输入'}], outputPorts: [{id:'out0',name:'角色成长'}] },
